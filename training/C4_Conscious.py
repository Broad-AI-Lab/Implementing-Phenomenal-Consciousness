...
from models.neural_nets import EX3ConvModel, AidedConvModel
...
SAVE_PATH = 'logs/'
OUTPUT_FILE = SAVE_PATH + "Conscious_Model4.csv"
...
def main(run, dataset_dict, print_messages=False):
    ...
    prefix = "Conscious_Model4"
    model = EX3ConvModel(num_outputs=30)
    ...
    aided_model = AidedConvModel(num_outputs=30)
...
if __name__ == "__main__":
    print('Conscious_Model4 training script')

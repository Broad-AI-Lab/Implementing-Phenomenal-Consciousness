...
SAVE_PATH = 'logs/'
OUTPUT_FILE = SAVE_PATH + "Conscious_Model2.csv"
...
def main(run, dataset_dict, print_messages=False):
    ...
    prefix = "Conscious_Model2"
    model = EX2ConvModel(num_outputs=30)
    ...
    aided_model = EX2AidedConvModel(num_outputs=30)
...
if __name__ == "__main__":
    print('Conscious_Model2 training script')

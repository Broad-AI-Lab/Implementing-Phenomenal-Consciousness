...
from models.neural_nets import NullConvModel
...
SAVE_PATH = 'logs/'
OUTPUT_FILE = SAVE_PATH + "Expanded_Model1.csv"
...
def main(run, dataset_dict, print_messages=False):
    ...
    prefix = "Expanded_Model1"
    model = NullConvModel(num_outputs=60)
...
if __name__ == "__main__":
    print('Expanded_Model1 training script')
